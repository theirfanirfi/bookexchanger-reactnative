...
class ListsTab extends React.Component {
    ...
    listHeader = () => {
        return (
            <Row>
                <Col style={{ width: '70%' }}>
                    <Input value={this.state.list_title} errorMessage={this.state.list_title_error_message} placeholder="Create New Stack" onChangeText={(text) => this.setState({ list_title: text })} />
                </Col>
                <Col>
                    <Button
